...
import java.util.Properties;
    ...
    public class DataProviderService {
        ...
        public static DataSource getDataSource() throws SQLException {
            if (dataSource == null) {
                Properties configuration = DataProviderService.loadProperties();
        ...
        private static Properties loadProperties() {
            try (InputStream input = DataProviderService.class.getClassLoader().getResourceAsStream("jdbc.properties")) {
                if (input == null) {
